...
>This url must return the list of inhabitants living at the given address as well as the number
...
**/person**
{ "firstName":"...", "lastName":"...", "address":"1509 Culver St", "city":"Culver", "zip":"97451", "phone":"2000006", "email":"jaboyd@email.com" } `
...
```  
{ "firstName":"...", "lastName":"...", "birthdate":"03/06/1984", "medications":["aznol:350mg", "hydrapermazol:100mg"], "allergies":["nillacilan"] }
```  
